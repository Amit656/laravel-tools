            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title m-0">{{ __('common.request') }}&nbsp;{{ __('common.tools') }}&nbsp;{{ __('common.history') }}</h3>
                    </div>
                    <div class="card-body">
                        <table id="requestToolHistoryTable" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">{{ __('common.tool') }}&nbsp;{{ __('common.request') }}&nbsp;{{ __('common.date') }}</th>
                                    <th class="text-center">{{ __('common.location') }}</th>
                                    <th class="text-center">{{ __('common.status') }}
                                    </th>
                                </tr>
                            </thead>
                        </table>
...
<script type="text/javascript" src="{{url('/assets/js/engineer/history_request_tool.js')}}"></script>
